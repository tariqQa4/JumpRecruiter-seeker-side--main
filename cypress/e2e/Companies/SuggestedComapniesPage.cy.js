...
import SuggestedCompaniesPage from '../../PageObjects/Companies/SuggestedCompaniesPage';
describe('companiesSuggested test suite', () => {
    const login = new Login()
    const suggestedcompaniespage = new  SuggestedCompaniesPage()
    ...
    it('job landing ',()=>{
        ...
        suggestedcompaniespage.clickOnCompaniesHeader()
        suggestedcompaniespage.clickOnSuggestedTab()
        suggestedcompaniespage.companyDeatilsOverview()
        
        suggestedcompaniespage.aboutJobTab()
        suggestedcompaniespage.reviewstab()
        suggestedcompaniespage.writeReview()
        suggestedcompaniespage.reportCompany()
        })
    })
})
