...
import SavedJob from '../../PageObjects/Job/SavedJobPage';

describe('Savedjob test suite', () => {
    ...
    it('Suggested job  ',()=>{
        savedjob.clickOnJobHeader()
        savedjob.clickOnSavedJobTab()
        savedjob.findJobFilter()
        savedjob.saveUnsaveJob()
